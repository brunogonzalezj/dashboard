    ...
    return (
        <div className="flex h-screen bg-gray-200 -z-50" >
            ...
            <header className=" sticky top-0 z-10">
                    <div className="max-w-7xl mx-auto pt-2 px-4 sm:px-6 lg:px-8 flex justify-end items-end">
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-2 bg-gray-300 shadow-2xl opacity-60 rounded-lg p-2">
